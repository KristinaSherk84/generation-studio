...
export default async function handler(
  ...
  try {
    ...
    if (similarImage) {
      ...
      const wideSuffix = commonPreamble + `\n3. EXPRESSION: match the target reference's expression closely.\n4. FRAMING: apply a SLIGHTLY WIDER crop than the target — pull the camera back by roughly 10–15% so more of the upper body and background is visible than in the target. Do NOT crop tighter than the target; wider only.\n5. VARIATION: subtle only, other than the wider crop.`;
