...
const BLOCK_3_STYLE: Record<Style, string> = {
  ...
  creative: `Style: Warm, approachable, personable. Softer edges than corporate. Hints of personality — a senior creative, a consultant, or a thought leader who does keynote talks. Less "Wall Street," more "TED stage." Background must be as blurry and creamy as possible, as if photographed with a prime 135mm lens with the background placed very far away from the subject. Choose ONE of the following background environments for this photograph: soft foliage / outdoor architectural blur, warm wood interior, exposed brick, or soft warm studio blur. Choose a background color that contrasts the subject's hair color so the subject pops clearly off the background. Absolutely zero expressionless eyes. The expression must be realistic, active, engaged, and smiling.`,
