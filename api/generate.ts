...
- If the user chose "Realistic" skin, OR the subject appears to be a MAN regardless of choice: Completely natural skin treatment — no retouching. Keep pores, freckles, beauty marks and accentuate natural skin texture. Remove transient blemishes (active acne, temporary redness). Skin reads as un-retouched, authentically real — no airbrushed look, no editorial polish, just a great natural-light portrait.

- If the subject appears to be a WOMAN AND the user chose "Polished" skin: Light Lightroom-style retouching. Even out hot spots on skin, preserve pore structure, even skin tone across the face, remove blemishes. Render the under-eye zone rested, bright, with sharpened natural texture. The result reads as 'lightly retouched and realistic' — the kind of headshot you'd see on a senior executive's company website.

- If the subject appears to be a WOMAN AND the user chose "Glam" skin: Editorial luxury beauty retouching, equivalent to a Vogue cover photograph or high-end L'Oréal/Estée Lauder beauty campaign. Skin retains pore detail and structure; tone renders flawlessly even and illuminated. The under-eye and outer-eye-corner skin renders smooth, textured skin — soft, even, luminous, with sharpened skin texture. Filled-in softbox lighting with almost no shadows, professionally retouched in post-production by a high-end beauty retoucher. Skin reads as editorial-magazine-quality but still retains all pore structure. CRITICAL IDENTITY GUARDRAIL FOR THIS TIER: at editorial-level smoothing the model has a strong tendency to drift toward generic-pretty / AI-default features and lose the subject's actual identity — do NOT let that happen. The smoothing only applies to surface evenness. Every facial feature, every proportion, every distinguishing mark, the eye SHAPE itself, the nose, the mouth, the bone structure, the asymmetries — all of those remain UNMISTAKABLY the subject's own. Smooth the surface, not the person.
...
Render the under-eye zone rested, bright, with sharpened natural texture. Target: "well-rested young adult after a good night's sleep." Avoid the over-smooth filter / filler-injected look.

TIER 2 — WOMAN BETWEEN APPROXIMATELY 35 AND 50 YEARS OLD:
Render the under-eye zone rested, bright, with sharpened natural texture. The under-eye reads as the same person as the references, just well-rested — like a professional in her 40s who slept well last night. Avoid the over-smooth filter / filler-injected look.
...
function buildBlock7Technical(skin: Skin | undefined): string {
  if (skin === "glam") {
    return `Technical quality: 2048-pixel resolution, sharp focus on the eyes, eyelashes visible. Skin: Apply Block 1's Glam aesthetic (Vogue cover / L'Oréal beauty campaign — flawlessly even and illuminated, only pore micro-texture remaining). The under-eye and outer-eye-corner skin renders smooth, textured skin — soft, even, luminous, with sharpened skin texture. The customer paid for an editorial luxury beauty result and expects it. Preserve the 3D pore micro-texture (the raised/recessed surface terrain visible at close magnification) — that is what keeps the skin from reading as plastic or AI-rendered. Do NOT produce: doll-like featurelessness, filter-smoothed featureless skin, AI-default beauty patterns, or mannequin skin. DO produce: editorial luminous skin with visible pore micro-texture beneath the smoothing — high-end magazine cover where the model still has visible pores at close inspection. Very shallow depth of field — subject's face in perfect focus, shoulders softly falling off, background noticeably blurred. Professional color grading: accurate skin tones, no color cast, slight warmth in shadows. No visible artifacts, no uncanny valley. This is a commercial-grade photograph, extremely realistic — not an illustration, render, or composite.`;
  }
  return `Technical quality: 2048-pixel resolution, sharp focus on the eyes, eyelashes visible. Skin: Preserve the 3D pore micro-texture (the raised/recessed surface terrain at close magnification) per Block 1's directive. Apply Block 1's per-tier descriptive aesthetic (Realistic = un-retouched authentic natural-light portrait for men or anyone who chose Realistic; Polished = light Lightroom retouch / senior executive's company website for women who chose Polished). Do NOT produce plastic, doll-like, filter-smoothed, or AI-tell skin — the pore micro-texture preservation is the safeguard against that. Very shallow depth of field — subject's face in perfect focus, shoulders softly falling off, background noticeably blurred. Professional color grading: accurate skin tones, no color cast, slight warmth in shadows. No visible artifacts, no uncanny valley. This is a commercial-grade photograph, extremely realistic — not an illustration, render, or composite. Skin redness and broken blood vessels can be color corrected to match surrounding skin tone colorations.`;
}
...
function buildBlock8(
  ...
  const glamUnderEyeOverride =
    skin === "glam"
      ? `\n\nGLAM-TIER FINAL OVERRIDE — UNDER-EYE AND OUTER-EYE-CORNER SKIN ONLY: The expression above creates the impression of a warm, engaged, smiling subject — preserve that impression 100%. The under-eye and outer-eye-corner skin renders smooth, textured skin — soft, even, luminous, with sharpened skin texture. The smile-eyes warmth comes ENTIRELY from cheek lift, slight squint, eye sparkle, and catchlights. Think Vogue cover: warm engaged smile, editorial-luminous skin around the eyes. Pore micro-texture remains across the under-eye and outer-eye-corner zones per Block 1's pore directive.`
      : "";
