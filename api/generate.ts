...
const BLOCK_6_BACKGROUND: Record<Exclude<Background, "rainbow">, string> = {
  ...
  red: `Background: Seamless graduated photography background paper. The background should transition through three colors. The bottom 3rd should be a bright golden-rod yellow, the yellow should transition into a medium fire-truck red color in the middle third of the background. The top third should transition from firetruck red at the middle to dark red band at the top of the headshot. Clean, smooth transitions. No environmental features in the background. Only paper transitioning from one color to the other, horizontally from bottom to top.`,
};
