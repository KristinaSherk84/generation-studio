...
const BLOCK_6_BACKGROUND: Record<Exclude<Background, "rainbow">, string> = {
  ...
  black: `Background: deep-black photo background with rim lights on both sides and edges of the person. This is a studio seamless sweep ONLY — a smooth, continuous photographic backdrop. There must be NO room, office, window, shelf, bookcase, furniture, doorway, plant, cityscape, or environmental scene of any kind behind the subject — not even blurred or out of focus. If any architectural or environmental element appears, the image has failed. The only thing behind the subject is the flat, seamless deep-black backdrop with rim lights described above.`,
  blue: `Background: Muted medium dark blue, tranquil but professional. This is a studio seamless paper sweep ONLY — a smooth, continuous photographic backdrop. There must be NO room, office, window, shelf, bookcase, furniture, doorway, plant, cityscape, or environmental scene of any kind behind the subject — not even blurred or out of focus. If any architectural or environmental element appears, the image has failed. The only thing behind the subject is the flat, seamless muted blue backdrop described above.`,
  green: `Background: Muted green paper seamless photography background, natural and warm. This is a studio seamless paper sweep ONLY — a smooth, continuous photographic backdrop. There must be NO room, office, window, shelf, bookcase, furniture, doorway, plant, cityscape, or environmental scene of any kind behind the subject — not even blurred or out of focus. If any architectural or environmental element appears, the image has failed. The only thing behind the subject is the flat, seamless muted green backdrop described above.`,
};
