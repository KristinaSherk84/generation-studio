...
const BLOCK_5_LIGHTING: Record<Lighting, string> = {
  ...
  dramatic: `Lighting: Illuminate a sliver of the face from top to bottom with Soft but directional, filled in light. A narrow but large, feathered key light — diffused, but positioned so the light illuminates a vertical sliver of th face. For THIS image, choose ONE of these two patterns:
