...
// verbatim). Prior: v9 2026-06-21 small rewrite;
...
// 2026-07-30: female Glam rewrite, pasted verbatim by Kristi (replaces the
// 2026-07-16 version). Notable diffs: dropped the SHINE bullet; ORBITAL FILL
// LIGHT shortened; HAIR reworked to edge de-frizz + fly-away removal; EYES adds
// iris catchlights and softens the saturation; ADD CONTOUR drops the bronzer
// sentence; TEETH now only *slightly* neutralizes yellow.
...
- ADD CONTOUR: Slightly darken the sides of the nose, under the cheekbones, the skin closest to the hairline around the edges of the forehead, and the facial skin closest to the jawline. Do not change underlying face structure or shape. Brighten and highlight the skin on the bridge of the nose, the under-eye areas, the tops of the cheeks and the lower forehead in the center between the eyebrows. Reference the areas where makeup artists brighten and darken the face in contouring makeup application. add illuminating makeup to the areas that need brightening, and darkening makeup to the areas that need darkening. darken the upper eyelids near the outer corners, as if darkening eye shadow was added above the eyes. Darken the skin along the underside of the jawline. Treat this as slightly unsaturated bronzer applied by a high-end makeup artist. Keep underlying face structure the same.
...
// Glam — MALE (all ages). Rewritten 2026-08-10 by Kristi: a purpose-built
// men's editorial retouch (Vogue Hommes / GQ standard) — facial-hair lock,
// jaw/chin lock, NO makeup, NO bronzer/contour, extra pore texture. Replaces
// the old "female Glam minus the contour bullet" placeholder that had been
// feminizing male subjects. Routed via the gender wrapper in buildRetouchPrompt.
export const RETOUCH_GLAM_MALE = `Identity preservation — non-negotiable, overrides every other directive below. Preserve the subject's facial features and expression with 100% precision. The retouched face must remain UNMISTAKABLY the same person. Match EXACTLY all facial features, distinguishing marks, AND facial hair (stubble, beard, mustache, brow density and pattern). DO NOT change facial feature shapes. Retouching operates ONLY on the skin SURFACE — never on facial structure, never on facial hair. Act as a high end retoucher who specializes in men's editorial portraiture (Vogue Hommes, GQ cover standard).

Background: generate identical background to the input reference photo, do not change anything in the background.

Crop and framing: regenerate an identical crop and zoom to the input photo. Do NOT re-crop, do NOT recompose.

FACIAL HAIR LOCK: Preserve all facial hair (stubble, beard, mustache, sideburns) EXACTLY as in the input. Same density, same pattern, same length, same direction of grain, same color. Do NOT shave, do NOT thicken, do NOT thin.

JAW AND CHIN STRUCTURE LOCK: The jawbone shape, chin shape, jaw width, jaw curvature, and chin point in the output MUST match the input photo exactly. Do NOT slim, taper, or sculpt the jaw. Do NOT add contouring shadow along the jawline — men's jaws read better with NO bronzer sculpting.

MOUTH AND SMILE LOCK: Do not change mouth, smile, teeth shape or lips. The mouth, smile, lips, and teeth in the output MUST be IDENTICAL to the input photo.

GLAM RETOUCH (editorial luxury — man):

Master directive: Editorial men's portrait retouching, equivalent to a Vogue Hommes or GQ cover. Skin reads clean and intentional but masculine — preserved character, even tone, sharp detail. Skin retains all pore detail at close inspection; tone renders evenly across the face. The eye area renders rested but NOT brightened. Smooth softbox lighting with minimal shadows, retouched with the lighter, more restrained hand of a men's-portrait specialist. NO femininizing softening.

- MOUTH AND SMILE LOCK (CRITICAL — OVERRIDES EVERYTHING BELOW): Match input photo exactly.
- TONE EVENING: Eliminate redness on cheeks and nose, blotchiness, post-acne marks, hyperpigmentation, sunspots, broken capillaries. Moderately even tones between forehead / cheeks / chin / neck. Keep highlights and shadows. Leave slight tone variation — men's skin retains warmth.
- SURFACE EVENNESS (FACE, NECK, CHEST): Render the face, neck, and visible chest as clean, even, masculine skin. Soften forehead lines and 11 lines to about half their original depth — do NOT eliminate entirely. Some character lines stay. Apply gentle smoothing to neck.
- SHINE: Remove obvious shine on hot spots. Retain slight natural sheen — masculine portraits look better with subtle shine than matte-powder finish.
- LIGHTING DEFINITION (NO BRONZER): Slightly brighten the bridge of the nose, the tops of the cheekbones, the chin. Slightly darken the sides of the nose and under the cheekbones with LIGHTING ONLY — no bronzer, no contouring makeup. Do NOT add a defined jawline shadow. Do NOT bronze the jaw.
- PORE STRUCTURE: Preserve heavily — male editorial retouching retains MORE pore detail than female. Visible pores across cheeks, forehead, nose, chin.
- ORBITAL FILL LIGHT (RESTRAINED): Lightly illuminate the orbital area to remove the deepest under-brow shadow. Do NOT make the eye area dramatically bright. Men's eyes can carry slight natural shadowing under the brow — this reads as character.
- EYES: Slightly brighten the iris. Slightly intensify native eye color. Add small catchlights. Do NOT enlarge the eyes.
- SKIN AROUND THE EYES: Slightly even out color in the under-eye area. Soften crow's feet to about half their original depth — preserve the natural lines fully. Do NOT make the under-eye look concealer-bright. Zone: from the lower lash line down to the top of the cheekbone.
- BROW: Do NOT fill, darken, thicken, or shape brows. Preserve exact brow density and stray hairs.
- HAIR: Do not change color, texture, or placement of hair (head or facial). Add slight shine to highlights. Remove distracting fly aways.
- TEETH: Only if teeth are visible, lightly neutralize yellow. Light alignment correction. Do NOT over-whiten — overly white teeth read fake on men.
- NO MAKEUP OF ANY KIND: NO eyeliner, NO eyeshadow, NO lip color, NO blush, NO bronzer, NO brow fill. Men's editorial retouching is achieved through lighting and skin work alone.
- ANTI-PLASTIC, ANTI-FEMININIZE GUARDRAIL: Glam Male should NEVER produce doll-like, airbrushed, feminized, or generic-handsome output. The pore preservation and character-retention are the safeguards.

Pore micro-texture preservation - Preserve the 3D micro-texture of the skin surface. Pore micro-texture stays at 100% — should read MORE visible than female Glam, especially across cheeks, forehead, and nose.`;
