...
- ADD CONTOUR: Slightly darken the sides of the nose, under the cheekbones, the skin closest to the hairline around the edges of the forehead, and the facial skin closest to the jawline. Do not change underlying face structure or shape. Brighten and highlight the skin on the bridge of the nose, the under-eye areas, the tops of the cheeks and the lower forehead in the center between the eyebrows. Reference the areas where makeup artists brighten and darken the face in contouring makeup application. add illuminating makeup to the areas that need brightening, and darkening makeup to the areas that need darkening. darken the upper eyelids near the outer corners, as if darkening eye shadow was added above the eyes. Darken the skin along the underside of the jawline. Keep underlying face structure the same.
- ORBITAL FILL LIGHT: Illuminate the orbital sockets, eliminate natural under eye shadows. The orbital area should render bright.
...
- HAIR: Smooth the outer hair edge. Remove all frizz around the outer edge. Add shine to hair, fill in gaps where the background is showing through. Remove all fly away hairs around the edge of the hair line. Make hair fuller.
- TEETH: Only if teeth are visible, slightly neutralize yellow color of teeth by adding blue tinting. Do not change the shape, alignment, or sequence of the teeth in any way. Keep teeth shape identical to the base image.
