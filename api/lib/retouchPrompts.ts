...
- ADD CONTOUR: Slightly darken the sides of the nose, under the cheekbones, the skin closest to the hairline around the edges of the forehead, and the facial skin closest to the jawline. Do not change underlying face structure or shape. Brighten and highlight the skin on the bridge of the nose, the under-eye areas, the tops of the cheeks and the lower forehead in the center between the eyebrows. Reference the areas where makeup artists brighten and darken the face in contouring makeup application. add illuminating makeup to the areas that need brightening, and darkening makeup to the areas that need darkening. darken the upper eyelids near the outer corners, as if darkening eye shadow was added. Darken the skin along the underside of the jawline. Treat this as slightly unsaturated bronzer applied by a high-end makeup artist. Keep underlying face structure the same.
...
- EYES: brighten the bottom portions of the irises. Intensify native eye color and add brightening and saturation. Amplify contrast around the eyes. Keep native eye shape identical to the base photo.
